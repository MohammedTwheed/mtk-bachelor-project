function [optimalHyperParams, finalMSE, randomSeed, bestTrainedNet] = optimizeNNForTrimmingPumpImpeller2(x, t)
    ...
    % gaOptions = optimoptions('ga', 'MaxTime', 5,'ConstraintTolerance',0.03,'FitnessLimit',0.09);
